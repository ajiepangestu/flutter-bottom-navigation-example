...
abstract class BottomNavigationBarPage extends StatefulWidget {
  const BottomNavigationBarPage({Key? key, required this.title, required this.subtitle}) : super(key: key);
  ...
  final navigationTitles = const ['Schedule', 'Contacts', 'Bills', 'Notes', 'Settings'];
